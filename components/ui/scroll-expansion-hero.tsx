    ...
    <section ref={sectionRef} className="relative min-h-[220svh]">
      <div className="sticky top-0 h-svh overflow-hidden">
        ...
        <div className="container-shell relative flex h-full flex-col justify-between pb-10 pt-28 sm:pb-14">
          ...
          <div
            className={cn(
              "relative z-10 max-w-5xl pt-8 sm:pt-12 lg:pl-10 lg:pt-16",
              textBlend ? "mix-blend-screen" : "",
            )}
          >
            <div className="max-w-4xl space-y-5 text-left">
              <p
                className="pl-1 text-xs uppercase tracking-[0.28em] mix-blend-normal"
                style={{
                  color: "#22c55e",
                  opacity: 1,
              ...
              <h1 className="max-w-4xl font-serif text-[3.2rem] leading-[0.94] text-white sm:text-[4.8rem] lg:text-[7rem]">
                {title}
              </h1>
            </div>
            {!isComplete ? (
